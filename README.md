...
**투자 후보 선별부터 AI 근거 조사, 최종 판단 검토까지 연결하는 개인 리서치 도구입니다.**

후보 종목을 GPT에 반복해서 입력하고 결과를 정리하던 불편에서 시작했습니다. 이 과정을 API로 연결하고, **AI가 판단을 바꾼 이유와 최종 반영 결과를 함께 확인**할 수 있도록 만들었습니다.
